...
ScopeTable :: ScopeTable(const int _bucketNUmber, const int _scopeUid,ScopeTable * _parentScope, string hashType) noexcept {
...
//main functions
bool ScopeTable :: Insert(string symbolName, string symbolType) noexcept{
    ...
    if(buckets[index] == nullptr){
        ...
        buckets[index] =new SymbolInfo(symbolName, symbolType);
        ...
        previous->setNextSymbolInfo(new SymbolInfo(symbolName, symbolType));
