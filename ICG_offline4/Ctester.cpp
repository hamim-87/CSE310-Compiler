...
#include "C2105160Parser.h"
#include "./symbol_table/2105160_symbol_info.hpp"
#include "./symbol_table/2105160_scope_table.hpp"
...
SymbolTable symbol_table(30,"SDBM",errorFile);
...
int main(int argc, const char* argv[]) {
    ...
    string parserLogFileName = outputDirectory + "code.asm";
    ...
    C2105160Lexer lexer(&input);
    CommonTokenStream tokens(&lexer);
    C2105160Parser parser(&tokens);
