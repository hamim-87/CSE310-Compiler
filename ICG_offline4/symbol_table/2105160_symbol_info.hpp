...
{   
    ...
    public:
        ...
        int offset;
        int is_global;
        SymbolInfo(const string& _symbolName, const string& _symbolType, SymbolInfo* _nextSymbolInfo = nullptr,FunctionInfo* _functionInfo = nullptr,bool _global = false) noexcept;
        ~SymbolInfo() noexcept;
